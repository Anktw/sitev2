...
const AboutMain = () => {
  ...
  const svgMapping = {
    ...
    Vite: "/icons/vitelogo.svg",
    Vue: "/icons/Vue.js_Logo_2.svg.png",
    Typescript: "/icons/icons8-typescript-48.png",
    Angular: "/icons/shield-large.svg",
    Next: (
      <svg
      ...
      <div className="w-full">
        ...
        {activeTab === "Tech Stacks" && (
          <div className="p-4 border border-foreground text-foreground rounded-lg mx-3 md:mx-5 animate-fadeInUp">
            ...
            <div className="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-4 gap-6 mx-auto my-4 lg:my-12 items-center">
              {techList.map((tech, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center space-y-6  p-4 backdrop-blur-sm rounded-[32px] shadow-[35px_0_0_rgba(145,192,255,0),inset_-7px_-7px_16px_0px_rgba(145,192,255,0.6),inset_0px_11px_28px_0px_rgb(255,255,255)] animate-fadeInDown"
                >
                  {svgMapping[tech] &&
